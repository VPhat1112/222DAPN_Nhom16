                                    ...
                                    <article class="card-body p-5">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-5">
                                                ...
                                                <input type="text" value="" name="soluong" placeholder="nhập số lượng muốn thuê" />
                                            </div> <!-- col.// -->

                                        </div> <!-- row.// -->
                                        <hr>
                                        <a href="#" class="btn btn-lg btn-primary text-uppercase"> Buy now </a>
                                        <a href="GioHang?bid=${detail.maThietBi} and " class="btn btn-lg btn-outline-primary text-uppercase"> <i class="fas fa-shopping-cart"></i> Add to cart </a>
                                    </article> <!-- card-body.// -->
                                </aside> <!-- col.// -->
                            </div> <!-- row.// -->
                        </div> <!-- card.// -->
