                    ...
                    <div class="row">
                        <c:forEach var="o" items="${ListP}" >
                            <div class="col-12 col-md-6 col-lg-4">
                                <div class="card">
                                    <img class="card-img-top" src="${o.hinhAnhString}" alt="Card image cap">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                ...
                                                <a href="GioHang?commad=insert&id=${detail.maThietBi}" title="Add to cart" class="btn btn-success btn-block">Add to cart</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
